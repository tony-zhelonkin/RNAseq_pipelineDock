...
FASTQC_OUTPUT_DIR="./pre_align_QC/fastQC"  # Output directory for FastQC reports
MULTIQC_OUTPUT_DIR="./pre_align_QC/multiQC"  # Output directory for MultiQC report
FASTQ_LOGS="./pre_align_QC/logs"  # Directory for logs
